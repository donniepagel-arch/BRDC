...
function renderEmpty(message) {
    ...
    els.detail.innerHTML = `<div class="ves-empty">${escapeHtml(message)} <a href="/pages/dart-trader-vnext.html">Browse trader</a></div>`;
}
...
function render(listing) {
    ...
    if (isOwner) {
        ...
        els.edit.href = `/pages/dart-trader-create-vnext.html?id=${encodeURIComponent(listing.id)}`;
    }
