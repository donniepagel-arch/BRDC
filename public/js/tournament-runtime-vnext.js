...
const tournamentId = params.get('tournament_id') || params.get('id');
...
function buildScorerUrl(match) {
    ...
    return `/pages/${page}?${query.toString()}`;
}
    ...
    return `
        <section class="ves-panel ves-runtime-settings">
            ...
            <div class="ves-runtime-actions">
                ...
                <a class="ves-action" href="/pages/tournament-bracket.html?tournament_id=${encodeURIComponent(tournamentId)}">Open bracket</a>
                <a class="ves-action" href="/pages/tournament-register-vnext.html?tournament_id=${encodeURIComponent(tournamentId)}">Registration</a>
            </div>
    ...
    return `
        <section class="ves-panel ves-matchmaker-runtime">
            ...
            <div class="ves-runtime-actions">
                ...
                <a class="ves-action" href="/pages/tournament-register-vnext.html?tournament_id=${encodeURIComponent(tournamentId)}">Register players</a>
                <a class="ves-action" href="/pages/tournament-bracket.html?tournament_id=${encodeURIComponent(tournamentId)}">Bracket</a>
                <a class="ves-action" href="/pages/matchmaker-mingle-vnext.html?tournament_id=${encodeURIComponent(tournamentId)}">Mingle page</a>
                <a class="ves-action" href="/pages/matchmaker-tv-vnext.html?tournament_id=${encodeURIComponent(tournamentId)}">TV display</a>
            </div>
...
function renderAll() {
    ...
    els.tournament.href = `/pages/tournament-view-vnext.html?tournament_id=${encodeURIComponent(tournamentId)}`;
    els.register.href = `/pages/tournament-register-vnext.html?tournament_id=${encodeURIComponent(tournamentId)}`;
    els.bracket.href = `/pages/tournament-bracket.html?tournament_id=${encodeURIComponent(tournamentId)}`;
...
async function deleteTournament() {
    ...
    window.location.href = '/pages/events-vnext.html';
}
