/**
 * Populate Pagel v Pagel Match with Turn-by-Turn Detail
 *
 * This script updates the Pagel v Pagel match with detailed throw-by-throw data
 * extracted from the DartConnect RTF export.
 */

const admin = require('firebase-admin');
const { getFirestore } = require('firebase-admin/firestore');

// Initialize with application default credentials from gcloud
...
const matchMetadata = {
    ...
    game_time_minutes: 157, // 2:37
    match_length_minutes: 192, // 3:12
    total_darts: 1505,
    total_games: 23,
    total_sets: 9,
    der: 82 // DartConnect Efficiency Rating
};

// Teams: M. Pagel (home) vs D. Pagel (away)
// Home: Matt Pagel, Joe Peters, John Linden
// Away: Donnie Pagel, Christian Ketchem, Jenn M
...
const games = [
    ...
    },
    {
        ...
        legs: [{
            ...
            throws: [
                { round: 1, home: { player: 'Matt Pagel', hit: 'S19', marks: 1, points: 0 }, away: { player: 'Donnie Pagel', hit: 'S20, T20', marks: 4, points: 0 } },
                { round: 2, home: { player: 'Joe Peters', hit: 'S19x2', marks: 2, points: 0 }, away: { player: 'Christian Ketchem', hit: '-', marks: 0, points: 20 } },
                { round: 3, home: { player: 'Matt Pagel', hit: 'S18x2', marks: 2, points: 0 }, away: { player: 'Donnie Pagel', hit: 'S19, T19', marks: 4, points: 20 } },
                { round: 4, home: { player: 'Joe Peters', hit: 'S18, T18', marks: 4, points: 54 }, away: { player: 'Christian Ketchem', hit: '-', marks: 0, points: 20 } },
                ...
                { round: 7, home: { player: 'Matt Pagel', hit: 'S20', marks: 1, points: 144 }, away: { player: 'Donnie Pagel', hit: 'S18, T20', marks: 4, points: 220 } },
                { round: 8, home: { player: 'Joe Peters', hit: 'T17, D17', marks: 5, points: 178, notable: '5M' }, away: { player: 'Christian Ketchem', hit: 'S18x2', marks: 2, points: 220 } },
                { round: 9, home: { player: 'Matt Pagel', hit: 'T16', marks: 3, points: 178 }, away: { player: 'Donnie Pagel', hit: 'S17, T17', marks: 4, points: 220 } },
                { round: 10, home: { player: 'Joe Peters', hit: 'T16', marks: 3, points: 226 }, away: { player: 'Christian Ketchem', hit: 'S20', marks: 1, points: 240 } },
                { round: 11, home: { player: 'Matt Pagel', hit: 'S15x2', marks: 2, points: 226 }, away: { player: 'Donnie Pagel', hit: 'S16, T16, S20', marks: 5, points: 260 } },
                { round: 12, home: { player: 'Joe Peters', hit: 'SB', marks: 1, points: 226 }, away: { player: 'Christian Ketchem', hit: 'T15, S15', marks: 4, points: 275 } },
                ...
                { round: 15, home: { player: 'Matt Pagel', hit: 'S15, S20', marks: 2, points: 326 }, away: { player: 'Donnie Pagel', hit: 'S20', marks: 1, points: 370 } },
                { round: 16, home: { player: 'Joe Peters', hit: '-', marks: 0, points: 326 }, away: { player: 'Christian Ketchem', hit: '-', marks: 0, points: 370 } },
                { round: 17, home: null, away: { player: 'Donnie Pagel', hit: 'DBx2', marks: 2, points: 370, notable: '3B', closed_out: true } }
            ]
        }]
    },
    {
    ...
    // ============= SET 2 =============
    {
        ...
        legs: [{
            ...
            player_stats: {
                'John Linden': { darts: 34, marks: 29, mpr: 2.56 },
                'Jenn M': { darts: 36, marks: 25, mpr: 2.08 }
            },
            throws: [
                ...
                { round: 12, home: { player: 'John Linden', hit: 'SB', marks: 1, closed_out: true }, away: { player: 'Jenn M', hit: 'SB', marks: 1 } }
            ]
        }]
    },
    {
        ...
        legs: [{
            ...
            player_stats: {
                'John Linden': { darts: 35, marks: 22, mpr: 1.89 },
                'Jenn M': { darts: 33, marks: 17, mpr: 1.55 }
            },
            throws: [
                ...
                { round: 12, home: { player: 'John Linden', hit: 'SBx2', marks: 2, closed_out: true }, away: null }
            ]
        }]
    },
    ...
    // ============= SET 3 =============
    {
        ...
        legs: [{
            ...
            player_stats: {
                'Matt Pagel': { darts: 23, marks: 23, mpr: 3.0 },
                'Donnie Pagel': { darts: 24, marks: 9, mpr: 1.13 }
            },
            throws: [
                ...
                { round: 8, home: { player: 'Matt Pagel', hit: 'DB', marks: 2, closed_out: true }, away: { player: 'Donnie Pagel', hit: 'SB', marks: 1 } }
            ]
        }]
    },
    {
        ...
        legs: [{
            ...
            player_stats: {
                'Matt Pagel': { darts: 39, marks: 34, mpr: 2.62 },
                'Donnie Pagel': { darts: 39, marks: 32, mpr: 2.46 }
            },
            throws: [
                ...
                { round: 10, home: { player: 'Matt Pagel', hit: 'S15x2', marks: 2, points: 157 }, away: { player: 'Donnie Pagel', hit: 'S16, S17x2', marks: 3, points: 180 } },
                { round: 11, home: { player: 'Matt Pagel', hit: 'DBx2, SB', marks: 5, points: 207, notable: '5B' }, away: { player: 'Donnie Pagel', hit: 'S15x3', marks: 3, points: 180 } },
                { round: 12, home: { player: 'Matt Pagel', hit: 'S15, SB', marks: 2, points: 232 }, away: { player: 'Donnie Pagel', hit: 'S16x2', marks: 2, points: 212 } },
                { round: 13, home: { player: 'Matt Pagel', hit: 'SB, D16', marks: 3, points: 257, closed_out: true }, away: { player: 'Donnie Pagel', hit: 'S16x2', marks: 2, points: 244 } }
            ]
        }]
    },
    ...
    // ============= SET 4 =============
    {
        ...
        legs: [{
            ...
            throws: [
                ...
                { round: 8, home: { player: 'John Linden', score: 18, remaining: 40 }, away: { player: 'Jenn M', score: 0, remaining: 26, miss: true } },
    ...
    },
    {
        ...
        legs: [{
            ...
            throws: [
                ...
                { round: 6, home: { player: 'John Linden', hit: 'D18', marks: 2, points: 20 }, away: { player: 'Jenn M', hit: 'S18', marks: 1 } },
                ...
                { round: 16, home: { player: 'John Linden', hit: 'SB', marks: 1 }, away: { player: 'Jenn M', hit: 'DB, SB', marks: 3, notable: '3B', closed_out: true } }
            ]
        }]
    },
    {
    ...
    // ============= SET 5 =============
    {
        ...
        legs: [{
            ...
            player_stats: {
                'Joe Peters': { darts: 41, marks: 28, mpr: 2.05 },
                'Christian Ketchem': { darts: 39, marks: 15, mpr: 1.15 }
            },
            throws: [
                ...
                { round: 14, home: { player: 'Joe Peters', hit: 'S16, SB', marks: 2, points: 128, closed_out: true }, away: null }
            ]
        }]
    },
    {
        ...
        legs: [{
            ...
            player_stats: {
                'Joe Peters': { darts: 40, marks: 29, mpr: 2.18 },
                'Christian Ketchem': { darts: 42, marks: 21, mpr: 1.5 }
            },
            throws: [
                ...
                { round: 14, home: { player: 'Joe Peters', hit: 'SB', marks: 1, closed_out: true }, away: { player: 'Christian Ketchem', hit: '-', marks: 0 } }
            ]
        }]
    },
    ...
    // ============= SET 6 =============
    {
        ...
        legs: [{
            ...
            player_stats: {
                'Matt Pagel': { darts: 24, points: 427, three_dart_avg: 53.38 },
                'Donnie Pagel': { darts: 27, points: 501, three_dart_avg: 55.67 }
            },
            checkout: 53,
            checkout_darts: 3,
            throws: [
    ...
    },
    {
        ...
        legs: [{
            ...
            player_stats: {
                'Matt Pagel': { darts: 27, points: 475, three_dart_avg: 52.78 },
                'Donnie Pagel': { darts: 30, points: 501, three_dart_avg: 50.1 }
            },
            checkout: 10,
            checkout_darts: 3,
            throws: [
                ...
                { round: 9, home: { player: 'Matt Pagel', score: 0, remaining: 26, miss: true }, away: { player: 'Donnie Pagel', score: 30, remaining: 10 } },
    ...
    },
    {
        ...
        legs: [{
            ...
            throws: [
                ...
                { round: 13, home: null, away: { player: 'Donnie Pagel', hit: 'SBx2', marks: 2, closed_out: true } }
            ]
        }]
    },
    {
    ...
    // ============= SET 8 =============
    {
        ...
        legs: [{
            ...
            player_stats: {
                'Joe Peters': { darts: 27, points: 461, three_dart_avg: 51.22 },
                'Christian Ketchem': { darts: 29, points: 501, three_dart_avg: 51.83 }
            },
            checkout: 47,
            checkout_darts: 2,
            throws: [
    ...
    },
    {
        ...
        legs: [{
            ...
            player_stats: {
                'Joe Peters': { darts: 34, points: 501, three_dart_avg: 44.21 },
                'Christian Ketchem': { darts: 33, points: 460, three_dart_avg: 41.82 }
            },
            checkout: 10,
            checkout_darts: 1,
            throws: [
                ...
                { round: 11, home: { player: 'Joe Peters', score: 0, remaining: 10, miss: true }, away: { player: 'Christian Ketchem', score: 37, remaining: 41 } },
    ...
    },
    {
        ...
        legs: [{
            ...
            player_stats: {
                'Joe Peters': { darts: 22, points: 501, three_dart_avg: 68.32 },
                'Christian Ketchem': { darts: 21, points: 358, three_dart_avg: 51.14 }
            },
            checkout: 16,
            checkout_darts: 1,
            throws: [
    ...
    // ============= SET 9 =============
    {
        ...
        legs: [{
            ...
            player_stats: {
                'John Linden': { darts: 33, points: 491, three_dart_avg: 44.64 },
                'Jenn M': { darts: 33, points: 501, three_dart_avg: 45.55 }
            },
            checkout: 45,
            checkout_darts: 3,
            throws: [
                ...
                { round: 10, home: { player: 'John Linden', score: 0, remaining: 10, miss: true }, away: { player: 'Jenn M', score: 45, remaining: 45 } },
                { round: 11, home: { player: 'John Linden', score: 0, remaining: 10, miss: true }, away: { player: 'Jenn M', score: 45, remaining: 0, checkout: true, checkout_darts: 3 } }
            ]
        }]
    },
    {
        ...
        legs: [{
            ...
            player_stats: {
                'John Linden': { darts: 34, points: 501, three_dart_avg: 44.21 },
                'Jenn M': { darts: 36, points: 487, three_dart_avg: 40.58 }
            },
            checkout: 32,
            checkout_darts: 1,
            throws: [
    ...
    },
    {
        ...
        legs: [{
            ...
            player_stats: {
                'John Linden': { darts: 34, points: 501, three_dart_avg: 44.21 },
                'Jenn M': { darts: 36, points: 461, three_dart_avg: 38.42 }
            },
            checkout: 18,
            checkout_darts: 1,
            throws: [
                ...
                { round: 10, home: { player: 'John Linden', score: 0, remaining: 18, miss: true }, away: { player: 'Jenn M', score: 37, remaining: 91 } },
                { round: 11, home: { player: 'John Linden', score: 0, remaining: 18, miss: true }, away: { player: 'Jenn M', score: 31, remaining: 60 } },
...
async function populateMatch() {
    console.log('=== Populating Pagel v Pagel Match with Detailed Data ===\n');
    ...
    try {
        ...
        console.log(`Total Sets: 9`);

        // Count detailed stats
        let totalThrows = 0;
        games.forEach(game => {
            game.legs.forEach(leg => {
                totalThrows += (leg.throws || []).length;
            });
        });
        console.log(`Total throw records: ${totalThrows}`);
