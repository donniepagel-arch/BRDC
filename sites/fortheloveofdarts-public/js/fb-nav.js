...
(function() {
    ...
    const IS_ROOKIES = window.location.pathname.startsWith('/rookies');
    const IS_VNEXT_PREVIEW = IS_ROOKIES || window.location.pathname.includes('-vnext');
    const ROUTES = IS_ROOKIES ? {
        home: '/rookies/dashboard/',
        events: '/rookies/pages/events-vnext.html',
        chat: '/rookies/pages/messages-vnext.html',
        scorer: '/rookies/pages/scorer-setup-vnext.html',
        trader: '/rookies/pages/dart-trader-vnext.html',
        captain: '/rookies/pages/captain-dashboard-vnext.html',
        profile: '/rookies/pages/player-profile-vnext.html',
        members: '/rookies/pages/members-vnext.html',
        director: '/rookies/pages/triples-vnext.html?league_id=rookies-demo-2026-triples#manage',
        admin: '/rookies/pages/admin-vnext.html'
    } : IS_VNEXT_PREVIEW ? {
        ...
        members: '/pages/members-vnext.html',
        director: '/pages/league-director-vnext.html',
        ...
        director: '/pages/league-director.html',
    ...
    const MENU_ITEMS = {
        ...
        manage: [
            ...
            { icon: 'settings', label: 'League Manage', href: ROUTES.director, role: 'director' },
            { icon: 'shield', label: 'Site Admin', href: ROUTES.admin, role: 'master_admin' }
        ],
        bottom: [
    ...
    class SearchOverlay {
        ...
        renderResults(results) {
            ...
            if (results.players && results.players.length) {
                ...
                results.players.forEach(player => {
                    html += `
                        <a href="${ROUTES.profile}?id=${encodeURIComponent(player.id)}" class="fb-search-result">
        ...
        renderLocalResults(query) {
            ...
            const quickLinks = [
                ...
                { icon: '👥', title: 'Members', href: ROUTES.members }
            ];
