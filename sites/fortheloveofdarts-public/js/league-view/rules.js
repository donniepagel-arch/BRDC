...
export function renderRules() {
    ...
    const isTriplesDraft = state.leagueId === 'aOq4Y0ETxPZ66tM1uUtP' || leagueName.includes('triples league') || leagueName.includes('triples draft');
    ...
    const playoffLabel = isTriplesDraft
        ? 'Top 6 Single Elimination'
        : (playoffLabels[state.leagueData.playoff_format] || 'No Playoffs');
            ...
            <div class="rules-card">
                ...
                <div class="rules-card-body">
                    ...
                    <div class="rules-item">
                        ...
                        <span class="rules-value">${playoffLabel}</span>
                    </div>
