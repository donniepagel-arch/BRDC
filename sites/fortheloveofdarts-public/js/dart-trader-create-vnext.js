...
async function loadEditListing() {
    ...
    if (editListing.seller_id && playerId && editListing.seller_id !== playerId) {
        window.location.href = `/rookies/pages/dart-trader-listing-vnext.html?id=${encodeURIComponent(listingId)}`;
        return;
    }
...
async function submitListing(event) {
    ...
    try {
        ...
        window.location.href = `/rookies/pages/dart-trader-listing-vnext.html?id=${encodeURIComponent(nextId)}`;
    } catch (error) {
