...
window.initBRDCNavigation = function (options = {}) {
    ...
    loadCSS('/css/brdc-navigation.css?v=14');
    ...
    loadScript('/js/fb-nav.js?v=14', function () {
    ...
    loadScript('/components/brdc-navigation.js?v=15', function () {
    ...
    loadScript('/js/chat-drawer.js?v=9');
};
...
window.BRDCNav = {
    ...
    goToLeague: function (leagueId) {
        window.location.href = window.location.pathname.startsWith('/rookies')
            ? `/rookies/pages/triples-vnext.html?league_id=${leagueId}`
            : `/pages/league-view.html?id=${leagueId}`;
    },

    // Navigate to profile
    goToProfile: function (playerId) {
        const profileBase = window.location.pathname.startsWith('/rookies')
            ? '/rookies/pages/player-profile-vnext.html'
            : '/pages/player-profile.html';
        if (playerId) {
            window.location.href = `${profileBase}?id=${playerId}`;
        } else {
