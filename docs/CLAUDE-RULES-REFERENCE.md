# BRDC Development Rules — DETAILED REFERENCE

> Extracted from CLAUDE.md on 2026-06-15 to keep CLAUDE.md lean (it was being
> re-injected on every file touch). CLAUDE.md now holds the operational core + a
> one-line index pointing here. Open this file when the CLAUDE.md index says to.
> (The working-dir / deploy / test-data sections below are duplicated verbatim for
> completeness; the canonical short versions live in CLAUDE.md.)
